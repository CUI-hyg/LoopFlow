...
整合 :class:`~loopflow.core.constraints.Constraints`（路径/行为门控）、
:class:`~loopflow.core.budget.Budget`（预算降级/杀停）、worktree 隔离与
:class:`~loopflow.core.state.State`（暂停标志）为统一的安全门控层，供
